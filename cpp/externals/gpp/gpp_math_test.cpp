...
class PingGPPKStar final : public PingableMatrixInputVectorOutputInterface {
 public:
  ...
  double GetAnalyticGradient(int row_index, int column_index, int output_index) const override OL_WARN_UNUSED_RESULT {
...
class PingGPPVariance final : public PingableMatrixInputVectorOutputInterface {
 public:
  ...
  PingGPPVariance(double const * restrict lengths, double const * restrict points_sampled, double const * restrict,
                  int const * restrict gradients, double alpha, int dim, int num_to_sample, int num_sampled, int num_gradients) OL_NONNULL_POINTERS
       : dim_(dim),
         num_to_sample_(num_to_sample),
         num_sampled_(num_sampled),
...
class PingGPPCovariance final : public PingableMatrixInputVectorOutputInterface {
 public:
  ...
  PingGPPCovariance(double const * restrict lengths, double const * restrict points_sampled, double const * restrict,
           int const * restrict gradients, double alpha, int dim, int num_to_sample, int num_sampled, int num_gradients) OL_NONNULL_POINTERS
     : dim_(dim),
       num_to_sample_(num_to_sample),
       num_sampled_(num_sampled),
...
class PingGPPCholeskyVariance final : public PingableMatrixInputVectorOutputInterface {
 public:
  ...
  PingGPPCholeskyVariance(double const * restrict lengths, double const * restrict points_sampled, double const * restrict,
                   int const * restrict gradients, double alpha, int dim, int num_to_sample, int num_sampled, int num_gradients) OL_NONNULL_POINTERS
        : dim_(dim),
          num_to_sample_(num_to_sample),
          num_sampled_(num_sampled),
...
class PingGPPCholeskyVarianceNoise final : public PingableMatrixInputVectorOutputInterface {
 public:
  ...
  PingGPPCholeskyVarianceNoise(double const * restrict lengths, double const * restrict points_sampled, double const * restrict,
                 int const * restrict gradients, double alpha, int dim, int num_to_sample, int num_sampled, int num_gradients) OL_NONNULL_POINTERS
      : dim_(dim),
        num_to_sample_(num_to_sample),
        num_sampled_(num_sampled),
  ...
  switch (domain_type) {
    case DomainTypes::kTensorProduct: {
      switch (ei_mode) {
        ...
        default: {
          OL_ERROR_PRINTF("%s: INVALID ei_mode choice: %d\n", OL_CURRENT_FUNCTION_NAME, static_cast<int>(ei_mode));
          return 1;
        }
    ...
    default: {
      OL_ERROR_PRINTF("%s: INVALID domain_type choice: %d\n", OL_CURRENT_FUNCTION_NAME, static_cast<int>(domain_type));
      return 1;
    }
