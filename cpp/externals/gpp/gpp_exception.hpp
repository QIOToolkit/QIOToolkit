...
/*!\rst
  ...
  ``char const *``, followed by the arguments in ``...`` (the __VA_ARGS__).
...
\endrst*/
#define OL_THROW_EXCEPTION(ExceptionType, ...) ThrowException(ExceptionType(OL_STRINGIFY_FILE_AND_LINE, OL_CURRENT_FUNCTION_NAME, __VA_ARGS__))
